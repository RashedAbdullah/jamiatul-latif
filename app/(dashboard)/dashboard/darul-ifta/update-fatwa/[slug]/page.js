import { getSingleFatwa, updateFatwa } from "@/actions/fatwa";
  ...
  const handleUpdateFatwa = async (formData) => {
    ...
    try {
      ...
      const updatedFatwa = {
        fatwa_no,
        categoryId,
        questionerId: singleFatwa.questionerId._id,
        answer,
        references,
      };

      await updateFatwa(slug, updatedFatwa);
    } catch (err) {
